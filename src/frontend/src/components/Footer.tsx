...
export function Footer({ version }: FooterProps) {
  ...
  return (
    <footer
      className="fixed bottom-0 left-0 right-0 h-8 bg-bg-secondary border-t border-border px-4 flex items-center justify-between text-xs z-50"
    ...
    >
      <div className="flex items-center gap-4">
        <a
          ...
          aria-label="GitHub project repository (opens in new window)"
        >
          <svg
            className="w-4 h-4"
            fill="currentColor"
